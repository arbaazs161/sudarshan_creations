...
class _CartCardWidState extends State<CartCardWid> {
  ...
  Widget build(BuildContext context) {
    final selectedVariant =
        widget.cartModel?.product?.variants.firstWhereOrNull((element) => element.id==widget.cartModel?.vId);
    final product = widget.cartModel?.product;
    double productTotal = widget.cartModel.qty.toDouble() * selectedVariant!.fixedPrice!.toDouble();
    if(qtyCtrl.text!=widget.cartModel?.qty.toString())qtyCtrl.text = widget.cartModel?.qty.toString()??"1";
    return Padding(
        ...
        children: [
          ...
          Padding(
            ...
            children: [
              Text(
                "Quantity",
                style: GoogleFonts.brawler(fontSize: 15, fontWeight: FontWeight.w500),
              ),
              InkWell(
                onTap: () {
            ...
            product != null &&
                    ...
                    selectedVariant.priceType == PriceTypeModel.fixedPrice
